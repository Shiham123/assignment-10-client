        ...
        >
          ...
          <AccordionBody>
            <span className="font-poppins leading-10 text-xl">
              ...
              <br /> We consider factors like budget, performance, features, and
              user preferences to provide recommendations that suit a variety of
              needs.
            </span>
          </AccordionBody>
        </Accordion>
        <Accordion open={openAcc2}>
          ...
          <AccordionBody>
            <span className="font-poppins leading-10 text-xl">
              ...
              team of experts thoroughly researches and tests products to ensure
              the information we provide is reliable and helpful. <br /> We also
        ...
        <Accordion open={openAcc3}>
          ...
          <AccordionBody>
            <span className="font-poppins leading-10 text-xl">
              ...
              deals. <br />
              <br />
              You can subscribe to our newsletter, follow us on social media, or
              regularly check our website for announcements on new products,
              discounts, and special offers from various tech brands.
            </span>
          </AccordionBody>
        </Accordion>
      </div>
